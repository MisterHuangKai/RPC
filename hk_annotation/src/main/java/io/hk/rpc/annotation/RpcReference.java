 ...
 * @HK注:
 * 1.服务消费者的注解@RpcReference是标注到字段上的.
 * 2.@Service
 *   public class ConsumerServiceImpl implements ConsumerService{
 *       @RpcReference(registryType="zookeeper",registryAddress="127.0.0.1:2181",loadBalanceType="zkconsistenthash",version="1.0.0",group="binghe",
 *       serializationType="protostuff",proxy="cglib",timeout=30000,async=true,oneway=false)
 *       private BingheService bingheService;
 *   }
 */
