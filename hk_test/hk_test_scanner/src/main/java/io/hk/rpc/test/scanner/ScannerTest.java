 ...
 */
package io.hk.rpc.test.scanner;

import io.hk.rpc.common.scanner.ClassScanner;
import io.hk.rpc.common.scanner.RpcReferenceScanner;
...
public class ScannerTest {
    ...
    public void testScannerClassNameList() throws Exception {
        List<String> classNameList = ClassScanner.getClassNameList("io.hk.rpc.test.scanner", true);
    ...
    public void testScannerClassNameListByRpcReference() throws Exception {
        RpcReferenceScanner.doScannerWithRpcReferenceAnnotationFilter("io.hk.rpc.test.scanner");
    }
}
