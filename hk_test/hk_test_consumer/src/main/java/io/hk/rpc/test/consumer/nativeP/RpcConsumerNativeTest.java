...
public class RpcConsumerNativeTest {
    ...
    public void initRpcClient() {
        rpcClient = new RpcClient("47.103.9.3:2181", "zookeeper", "javassist", "1.0.0", "hk", "protostuff", 3000L, false, false);
    }
    ...
    public void testAsyncInterfaceRpc() throws Exception {
        RpcClient rpcClient = new RpcClient("47.103.9.3:2181", "zookeeper", "jdk", "1.0.0", "hk", "hessian2", 3000L, true, false);
