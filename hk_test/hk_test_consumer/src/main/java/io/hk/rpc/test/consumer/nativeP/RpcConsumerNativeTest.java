...
public class RpcConsumerNativeTest {
    ...
    public void initRpcClient() {
        rpcClient = new RpcClient("127.0.0.1:2181", "zookeeper", "1.0.0", "hk", "jdk", 3000L, false, false);
    }
    ...
    public static void main(String[] args) {
        RpcClient rpcClient = new RpcClient("127.0.0.1:2181", "zookeeper", "1.0.0", "hk", "jdk", 3000L, false, false);
        DemoService demoService = rpcClient.create(DemoService.class);
    ...
    public void testAsyncInterfaceRpc() throws Exception {
        RpcClient rpcClient = new RpcClient("127.0.0.1:2181", "zookeeper", "1.0.0", "hk", "jdk", 3000L, true, false);
